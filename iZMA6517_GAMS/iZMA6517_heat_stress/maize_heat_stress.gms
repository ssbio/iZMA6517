...
$include "v_min.txt"
	...
	v_omics(j)				reference state of v(j) calculated from the GPR relation
...
biomass..			v('Root_Biomass[R]') + v('Shoot_Biomass[S]') + v('Seed_Biomass[K]') + v('Leaf_Biomass[L]') =e= 0.625;
...
solve maize using lp minimizing Z;
********************************************
****************Output File*****************
